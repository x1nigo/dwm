...
static const unsigned int gappih    = 46;       /* horiz inner gap between windows */
static const unsigned int gappiv    = 42;       /* vert inner gap between windows */
static const unsigned int gappoh    = 42;       /* horiz outer gap between windows and screen edge */
static const unsigned int gappov    = 58;       /* vert outer gap between windows and screen edge */
